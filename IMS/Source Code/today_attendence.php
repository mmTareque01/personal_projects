...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      ...
      <a href="today_attendence.php" class="button button--error" data-for="js_success-popup">No</a>
    </p>
  </div>
</div>
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Today's Attendence</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Today's Attendence</li>
                    </ol>
                </div>
            </div>
                 ...
                 <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    {
                                      $class = $_POST['class'];
                                      $sql = "SELECT * FROM tbl_attendence WHERE classname = '".$_POST['class']."' AND `date` = '".$current_date."' ";
                                    }
                                    else
                                    {
                                      $sql = "SELECT * FROM `tbl_attendence` WHERE `date` = '".$current_date."' ";
                                    }
