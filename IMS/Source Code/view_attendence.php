...
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <?php if(isset($useroles)){  if(in_array("edit_attendence",$useroles)){ ?> 
                                                <a href="edit_attendence.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-plus-square"></i></button></a>
                                              <?php } } ?>

            <?php if(isset($useroles)){  if(in_array("delete_attendence",$useroles)){ ?> 
                                                <a href="view_attendence.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="fa fa-trash"></i></button></a>
                                              <?php } } ?>
                                                </td>
                                            </tr>
                                          <?php $i++; } ?>
