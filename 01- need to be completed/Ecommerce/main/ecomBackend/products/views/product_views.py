...
from products.forms.products_form import ProductsForm
from products.models import Products
from products.serializers import Products_Serializers
...
def get_products(request):
    ...
    try:
        ...
        serializer = Products_Serializers(result_page, many=True)
...
@api_view(['GET'])
def get_products_details(request, id):
    print(request)
    try:
        # products = Products.objects.all().filter("id" = id)
