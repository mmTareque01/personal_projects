...
"rtl" == $("html").data("textdirection") && (direction = "rtl"),
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		$(d).on("click", function () {
			if (l.valid()) {
				var e = { id: E.getEvents().length + 1, title: s.val(), start: v.val(), end: u.val(), startStr: v.val(), endStr: u.val(), display: "block", extendedProps: { location: h.val(), guests: f.val(), calendar: c.val(), description: C.val() } };
			...
			o.on("click", function () {
				l.valid() &&
					...
					})({ id: e.id, title: a.find(s).val(), start: a.find(v).val(), end: a.find(u).val(), url: p.val(), extendedProps: { location: h.val(), guests: f.val(), calendar: c.val(), description: C.val() }, display: "block", allDay: !!m.prop("checked") }),
					a.modal("hide"));
			}),
