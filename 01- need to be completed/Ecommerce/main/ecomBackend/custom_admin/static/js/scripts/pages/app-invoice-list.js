		...
		var dtInvoice = dtInvoiceTable.DataTable({
			...
			columnDefs: [
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						return "<span data-bs-toggle='tooltip' data-bs-html='true' title='<span>" + $invoiceStatus + '<br> <span class="fw-bold">Balance:</span> ' + $balance + '<br> <span class="fw-bold">Due Date:</span> ' + $dueDate + "</span>'>" + '<div class="avatar avatar-status ' + roleObj[$invoiceStatus].class + '">' + '<span class="avatar-content">' + feather.icons[roleObj[$invoiceStatus].icon].toSvg({ class: "avatar-icon" }) + "</span>" + "</div>" + "</span>";
					},
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						var $rowOutput = '<div class="d-flex justify-content-left align-items-center">' + '<div class="avatar-wrapper">' + '<div class="avatar' + colorClass + 'me-50">' + $output + "</div>" + "</div>" + '<div class="d-flex flex-column">' + '<h6 class="user-name text-truncate mb-0">' + $name + "</h6>" + '<small class="text-truncate text-muted">' + $email + "</small>" + "</div>" + "</div>";
						return $rowOutput;
					},
				},
				{
			...
			initComplete: function () {
				...
				this.api()
					...
					.every(function () {
						var column = this;
						var select = $('<select id="UserRole" class="form-select ms-50 text-capitalize"><option value=""> Select Status </option></select>')
