$(function () {
	...
	if (("laravel" === $("body").attr("data-framework") && ((a = $("body").attr("data-asset-path")), (e = a + "app/invoice/preview"), (n = a + "app/invoice/add"), (s = a + "app/invoice/edit")), t.length))
		t.DataTable({
				...
				},
				{
					...
					render: function (t, a, e, n) {
						var s = e.invoice_status,
							i = e.due_date,
							o = { Sent: { class: "bg-light-secondary", icon: "send" }, Paid: { class: "bg-light-success", icon: "check-circle" }, Draft: { class: "bg-light-primary", icon: "save" }, Downloaded: { class: "bg-light-info", icon: "arrow-down-circle" }, "Past Due": { class: "bg-light-danger", icon: "info" }, "Partial Payment": { class: "bg-light-warning", icon: "pie-chart" } };
			...
			language: { sLengthMenu: "Show _MENU_", search: "Search", searchPlaceholder: "Search Invoice", paginate: { previous: "&nbsp;", next: "&nbsp;" } },
			buttons: [
				{
					text: "Add Record",
			...
			initComplete: function () {
				$(document).find('[data-bs-toggle="tooltip"]').tooltip(),
					this.api()
						...
						.every(function () {
							var t = this,
								a = $('<select id="UserRole" class="form-select ms-50 text-capitalize"><option value=""> Select Status </option></select>')
