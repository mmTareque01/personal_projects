...
(window.colors = { solid: { primary: "#7367F0", secondary: "#82868b", success: "#28C76F", info: "#00cfe8", warning: "#FF9F43", danger: "#EA5455", dark: "#4b4b4b", black: "#000", white: "#fff", body: "#f8f8f8" }, light: { primary: "#7367F01a", secondary: "#82868b1a", success: "#28C76F1a", info: "#00cfe81a", warning: "#FF9F431a", danger: "#EA54551a", dark: "#4b4b4b1a" } }),
	(function (a, e, t) {
		"use strict";
		var s = t("html"),
			n = t("body"),
		...
		if (
			...
			t(a).on("load", function () {
				...
				t('a[data-action="collapse"]').on("click", function (a) {
					...
					t(".touchspin-cart").length > 0 && t(".touchspin-cart").TouchSpin({ buttondown_class: "btn btn-primary", buttonup_class: "btn btn-primary", buttondown_txt: feather.icons.minus.toSvg(), buttonup_txt: feather.icons.plus.toSvg() }),
					...
					t('a[data-action="reload"]').on("click", function () {
						...
						a.block({ message: feather.icons["refresh-cw"].toSvg({ class: "font-medium-1 spinner text-primary" }), timeout: 2e3, overlayCSS: { backgroundColor: e, cursor: "wait" }, css: { border: 0, padding: 0, backgroundColor: "none" } });
					}),
						...
						t.getJSON(r + "data/" + p + ".json", function (a) {
							...
							for (m = 0; m < a.listItems.length; m++) {
								...
								0 != a.listItems[m].name.toLowerCase().indexOf(e) &&
									...
									f < 5 &&
									((l += '<li class="auto-suggestion ' + (0 === f ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + a.listItems[m].url + '><div class="d-flex justify-content-start align-items-center">' + feather.icons[a.listItems[m].icon].toSvg({ class: "me-75 " }) + "<span>" + a.listItems[m].name + "</span></div>" + h + "</a></li>"), f++);
							}
				...
				(function (a) {
					...
					s.removeClass("semi-dark-layout dark-layout bordered-layout"),
						"dark-layout" === l
							...
							: "bordered-layout" === l
							? (s.addClass("bordered-layout"), o.removeClass("menu-dark").addClass("menu-light"), r.removeClass("navbar-dark").addClass("navbar-light"), e.find(".ficon").replaceWith(feather.icons.moon.toSvg({ class: "ficon" })))
							: "semi-dark-layout" === l
							? (s.addClass("semi-dark-layout"), o.removeClass("menu-dark").addClass("menu-light"), r.removeClass("navbar-dark").addClass("navbar-light"), e.find(".ficon").replaceWith(feather.icons.moon.toSvg({ class: "ficon" })))
							: (s.addClass("light-layout"), o.removeClass("menu-dark").addClass("menu-light"), r.removeClass("navbar-dark").addClass("navbar-light"), e.find(".ficon").replaceWith(feather.icons.moon.toSvg({ class: "ficon" })));
