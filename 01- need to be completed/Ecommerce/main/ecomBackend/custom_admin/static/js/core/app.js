    ...
    */
	...
	bookmarkStar.on("click", function (e) {
		...
		for (var i = 0; i < arrList.length; i++) {
			...
			$arrList +=
				'<li class="auto-suggestion ' + $activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + arrList[i].firstChild.href + ">" + '<div class="d-flex justify-content-start align-items-center">' + feather.icons[iconName].toSvg({ class: "me-75 " + className }) + "<span>" + arrList[i].firstChild.dataset.bsOriginalTitle + "</span>" + "</div>" + feather.icons["star"].toSvg({ class: "text-warning bookmark-icon float-end" }) + "</a>" + "</li>";
		}
