$(function () {
	...
	if ($("#shape-map").length) {
		...
		L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(r);
	}
	if ($("#drag-map").length) {
		var a = L.map("drag-map").setView([48.817152, 2.455], 12);
		L.marker([48.817152, 2.455], { draggable: "true" }).addTo(a).bindPopup("<b>You're here!</b>").openPopup(), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(a);
	}
	if ($("#user-location").length) {
		...
		i.locate({ setView: !0, maxZoom: 16 }), i.on("locationfound", e), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(i);
	}
	if ($("#custom-icons").length) {
		var n = L.map("custom-icons").setView([51.5, -0.09], 10),
			p = L.icon({ iconUrl: e + "images/misc/leaf-green.png", shadowUrl: e + "images/misc/leaf-shadow.png", iconSize: [38, 95], shadowSize: [50, 64], iconAnchor: [22, 94], shadowAnchor: [4, 62], popupAnchor: [-3, -76] }),
			y = L.icon({ iconUrl: e + "images/misc/leaf-red.png", shadowUrl: e + "images/misc/leaf-shadow.png", iconSize: [38, 95], shadowSize: [50, 64], iconAnchor: [22, 94], shadowAnchor: [4, 62], popupAnchor: [-3, -76] }),
			s = L.icon({ iconUrl: e + "images/misc/leaf-orange.png", shadowUrl: e + "images/misc/leaf-shadow.png", iconSize: [38, 95], shadowSize: [50, 64], iconAnchor: [22, 94], shadowAnchor: [4, 62], popupAnchor: [-3, -76] });
		L.marker([51.5, -0.09], { icon: y }).addTo(n), L.marker([51.4, -0.51], { icon: p }).addTo(n), L.marker([51.49, -0.45], { icon: s }).addTo(n), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(n);
	}
	if ($("#geojson").length) {
		var d = L.map("geojson").setView([44.2669, -72.576], 3);
		function e(e) {
			return { fillColor: ((t = e.properties.density), t > 1e3 ? "#800026" : t > 500 ? "#BD0026" : t > 200 ? "#E31A1C" : t > 100 ? "#FC4E2A" : t > 50 ? "#FD8D3C" : t > 20 ? "#FEB24C" : t > 10 ? "#FED976" : "#FFEDA0"), weight: 2, opacity: 1, color: "white", dashArray: "3", fillOpacity: 0.7 };
			var t;
		}
		L.geoJson(t).addTo(d), L.geoJson(t, { style: e }).addTo(d), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(d);
	}
	if ($("#layer-control").length) {
		var m = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO."),
			...
			h = L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }),
			P = L.tileLayer("http://tile.stamen.com/watercolor/{z}/{x}/{y}.jpg", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }),
			F = L.map("layer-control", { center: [39.73, -104.99], zoom: 10, layers: [h, u] }),
			w = { Street: h, Watercolor: P },
			f = { Cities: u };
		L.control.layers(w, f).addTo(F), L.tileLayer("https://c.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(F);
	}
});
