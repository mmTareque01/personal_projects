$(function () {
	...
	if (addMemberSelect.length) {
		function renderGuestAvatar(option) {
			...
			var $avatar = "<div class='d-flex flex-wrap align-items-center'>" + "<div class='avatar avatar-sm my-0 me-50'>" + "<span class='avatar-content'>" + "<img src='" + assetsPath + "images/avatars/" + $(option.element).data("avatar") + "' alt='avatar' />" + "</span>" + "</div>" + option.text + "</div>";
