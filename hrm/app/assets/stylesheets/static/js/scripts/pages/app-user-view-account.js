			...
			columnDefs: [
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						if ($image) {
							// For Avatar image
							var $output = '<img src="' + assetPath + "images/icons/brands/" + $image + '" alt="Project Image" width="32" class="rounded-circle">';
						} else {
							// For Avatar badge
						...
						var $row_output = '<div class="d-flex justify-content-left align-items-center">' + '<div class="avatar-wrapper">' + '<div class="avatar me-1">' + $output + "</div>" + "</div>" + '<div class="d-flex flex-column">' + '<span class="text-truncate fw-bolder">' + $name + "</span>" + '<small class="text-muted">' + $framework + "</small>" + "</div>" + "</div>";
						return $row_output;
					},
				},
				{
