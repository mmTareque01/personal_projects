$(function () {
	var e = $(".user-list-table"),
		...
		s = { 1: { title: "Pending", class: "badge-light-warning" }, 2: { title: "Active", class: "badge-light-success" }, 3: { title: "Inactive", class: "badge-light-secondary" } };
	"laravel" === $("body").attr("data-framework") && ((t = $("body").attr("data-asset-path")), (a = t + "app/user/view/account")),
		e.length &&
			e.DataTable({
					...
					},
					{
						...
						render: function (e, s, n, l) {
							var r = n.full_name,
								c = n.email,
								o = n.avatar;
							if (o) var i = '<img src="' + t + "images/avatars/" + o + '" alt="Avatar" height="32" width="32">';
							else {
					...
					},
					{
						...
						render: function (e, t, a, s) {
							...
							return (
								...
								{ Subscriber: feather.icons.user.toSvg({ class: "font-medium-3 text-primary me-50" }), Author: feather.icons.settings.toSvg({ class: "font-medium-3 text-warning me-50" }), Maintainer: feather.icons.database.toSvg({ class: "font-medium-3 text-success me-50" }), Editor: feather.icons["edit-2"].toSvg({ class: "font-medium-3 text-info me-50" }), Admin: feather.icons.slack.toSvg({ class: "font-medium-3 text-danger me-50" }) }[n] +
								n +
								"</span>"
							);
						},
