...
document.addEventListener("DOMContentLoaded", function () {
	...
	if (eventLabel.length) {
		function renderBullets(option) {
			...
			var $bullet = "<span class='bullet bullet-" + $(option.element).data("label") + " bullet-sm me-50'> " + "</span>" + option.text;
	...
	if (eventGuests.length) {
		function renderGuestAvatar(option) {
			...
			var $avatar = "<div class='d-flex flex-wrap align-items-center'>" + "<div class='avatar avatar-sm my-0 me-50'>" + "<span class='avatar-content'>" + "<img src='" + assetPath + "images/avatars/" + $(option.element).data("avatar") + "' alt='avatar' />" + "</span>" + "</div>" + option.text + "</div>";
