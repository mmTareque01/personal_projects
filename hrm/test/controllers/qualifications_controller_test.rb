...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference("Qualification.count") do
      post qualifications_url, params: { qualification: { description: @qualification.description, meta: @qualification.meta, name: @qualification.name } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { description: @qualification.description, meta: @qualification.meta, name: @qualification.name } }
