...
class JobTitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_title" do
    assert_difference("JobTitle.count") do
      post job_titles_url, params: { job_title: { description: @job_title.description, meta: @job_title.meta, name: @job_title.name } }
    end
  ...
  test "should update job_title" do
    patch job_title_url(@job_title), params: { job_title: { description: @job_title.description, meta: @job_title.meta, name: @job_title.name } }
