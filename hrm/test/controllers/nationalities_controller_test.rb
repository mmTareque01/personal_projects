...
class NationalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nationality" do
    assert_difference("Nationality.count") do
      post nationalities_url, params: { nationality: { country: @nationality.country, name: @nationality.name } }
    end
  ...
  test "should update nationality" do
    patch nationality_url(@nationality), params: { nationality: { country: @nationality.country, name: @nationality.name } }
